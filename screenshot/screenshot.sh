...
# Load Settings
if [ -f ~/Pictures/Screenshots ]; then
    SAVE_DIR=$(cat ~/Pictures/Screenshots)
fi
if [ -f ~/Pictures/Screenshots/screenshot-filename ]; then
    SAVE_FILENAME=$(cat ~/Pictures/Screenshots/screenshot-filename)
fi
